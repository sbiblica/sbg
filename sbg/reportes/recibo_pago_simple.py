...
report_sxw.report_sxw('report.recibo.pago.simple', 'hr.payslip', 'mis_modulos/sbg/reportes/recibo_pago_simple.rml', parser=payment_order_report_len1, header=False)
