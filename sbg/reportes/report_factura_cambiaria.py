...
class report_factura_cambiaria(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(report_factura_cambiaria, self).__init__(cr, uid, name, context=context)
    ...
    def descuento(self, obj):
        ...
        log = netsvc.Logger()
        log.notifyChannel('FUNCION DESCUENTO.............', netsvc.LOG_WARNING, str(obj.tienda))
        log.notifyChannel('FUNCION DESCUENTO.............', netsvc.LOG_WARNING, str(obj.add_disc))
        log.notifyChannel('FUNCION DESCUENTO.............', netsvc.LOG_WARNING, str(obj.write_date))

        return obj.add_disc_amt

report_sxw.report_sxw(
    'report.factura.cambiaria',
    'account.invoice',
    'sbg/reportes/factura_cambiaria.rml',
    parser=report_factura_cambiaria
)
